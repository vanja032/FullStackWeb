...
<html lang="en" self="gallery">
  <head>
    ...
    <title>Arso nameštaj - Galerija slika</title>
  </head>
    ...
    <nav class="navbar navbar-expand-* navbar-light form-row">
        ...
        <div class="collapse navbar-collapse rounded" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto my-4">
            ...
            <li class="nav-item mx-2">
              <a class="nav-link color-custom2 menu_link_hover2 current_page2 px-4" href="gallery.php">Galerija</a>
            </li>
            ...
            <?php
              ...
              <li class="mobile_panel nav-item mx-2" style="display: none;">
                ...
                echo
                '<li class="mobile_panel nav-item mx-2" style="display: none;">
                <a class="nav-link nav-link_b color-custom1 menu_link_hover2 px-4" href="login.php">Prijavi se</a>
              </li>';
              }?>
          </ul>
        </div>
      </nav> 
    <div class="container checkboxes mt-5">
      ...
      <section class="gallery-block cards-gallery">
        <div class="container">
            <div class="heading">
              <h2 class="color-custom2">Galerija slika</h2>
            </div>
