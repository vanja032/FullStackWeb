...
<html lang="en">
  <head>
    ...
    ?>
    <title>Arso nameštaj - Prijava</title>
  </head>
    <body>
        ...
        <div class="collapse navbar-collapse rounded" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto my-4">
            <li class="nav-item mx-2">
              <a class="nav-link color-custom2 menu_link_hover2 px-4" href="index.php">Naslovna</a>
            </li>
            <li class="nav-item mx-2">
            ...
            <li class="nav-item mx-2 desktop_panel current_page2" style="position: relative;">
      ...
      <div class="container my-5">
        <h2 class="color-custom4" style="text-align: center;">Prijava</h2>
          ...
          <div class="col-sm-10 col-md-6 col-lg">
            <form>
              <div class="form-group">
                <label for="loginUsername" class="color-custom3">Email ili Korisničko ime</label>
                <input type="text" class="form-control rounded-pill" id="loginUsername" placeholder="Email or Username">
                <small id="usernameHelp" class="form-text text-muted color-custom5"></small>
              </div>
              <div class="form-group">
                <label for="loginPassword" class="color-custom3">Šifra</label>
                <input type="password" class="form-control rounded-pill" id="loginPassword" placeholder="Password">
                <small id="passwordHelp" class="form-text text-muted color-custom5"></small>
              </div>
              <small id="loginsubmitHelp" class="form-text text-muted color-custom5"></small>
              <button type="button" id="loginButton" class="btn custom-btn1 rounded-pill w-100 mt-4">Prijavite se</button>
            </form>
          </div>
          <div class="col-sm-1 col-md-3 col-lg">
          </div>
